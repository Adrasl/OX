...
\begin{itemize}
\item MeshFactory: Creación de un modelo3D a partir de una nube de puntos basado en Marching Cubes y Metaballs.
...
Se revisan algunas secciones generales. Sin embargo, el trabajo de esta fase se centra en el módulo de Producción y en la aplicación principal. 
...
Por otro lado, se crea la clase IEntity para poder manipular diferentes implementaciones de entidades, añadiendo métodos para actualización de estado durante su ejecución en el pipeline de producción, así como métodos para acceder a los nuevos atributos de audio y colisiones.
\\

Para terminar a la percepción de video métodos para obtener información más enriquecida sobre área, orientación, excentricidad, y dirección e intensidad de velocidad en la detección de movimiento.
...
Por considerarse básicos y muy útiles se añaden atributos de velocidad y aceleración a la persistencia de la entidad. También se añaden métodos para obtener el ID que identifica a cada instancia.
...
No hay cambios, mencionar en todo caso que retoramos la gestión de permisos y fullscreen.
...
GetMotionElements y GetMotionAtCoords. Record and use video, eccentricity, orientation.
...
Boids, Swarm: separación, cohesión, alineación, atracción, evasión, randomicidad, límites.
...
\subsubsection{Módulo de Producción}
\subsubsection{Módulo de Percepción}
Aunque es realmente interesante el estudio del reconocimiento postural, se ha optado por una solución más simple. Sin embargo, me gustaría resaltar artículos como el estudio de un modelo de voxels del usuario obtenido a partir de mútiples cámaras, como puede leerse en el trabajo "Articulated Body Posture Estimation from Multi-Camera Voxel Data" de Ivana Mikic \cite{IVANAM} o la detección de articulaciones para estimar la pose del esqueleto del usuario como puede leerse en "Estimating Human Body configurations using Shape Context Matching" de Greg Mori \cite{GREGMJM}. \\
