...
Destacar que se usa una modificación a la hora de asignar las primitivas usando un cálculo de distancia que nos permita conseguir un acabado de metabola, de forma que si dos puntos están los suficientemente cerca (o son lo suficientemente grandes) se crea una superficie más suavizada que los conecta). 
\\
